<template>
  <div class="overview">
    ...
    <i-card title="技术栈">
      <i-text-link :text-arrs="technologyStacks" />
      <i-descriptions title="生产环境依赖" :column="2" :table-datas="dependencies" />
      <i-descriptions title="开发环境依赖" :column="2" :table-datas="devDependencies" />
    </i-card>
    <i-card title="项目结构">
      <div class="c-left">
        <i-code language="bash" :code="projectDir" />
      </div>
    </i-card>
    <i-card title="项目规范">
      <i-descriptions
...
import IDescriptions from '@/base-ui/descriptions'
import ITextLink from '@/base-ui/text-link'
import ICode from '@/base-ui/code'
